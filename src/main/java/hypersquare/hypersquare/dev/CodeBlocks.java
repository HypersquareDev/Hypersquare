...
public enum CodeBlocks {
    ...
    COBBLESTONE(Material.COBBLESTONE, "PLAYER ACTION", "player_action", false, false),
    ...
    MOSSY_COBBLESTONE(Material.MOSSY_COBBLESTONE, "ENTITY ACTION", "entity_action", false, false),
    ...
    NETHERRACK(Material.NETHERRACK, "GAME ACTION", "game_action", false, false),
